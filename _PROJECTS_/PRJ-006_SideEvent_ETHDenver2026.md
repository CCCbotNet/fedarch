# PRJ-006: #SideEvent_ETHDenver2026

## 📋 PRJ-006_SideEvent_ETHDenver2026_v3.1.2.1.md
## ♾️ WeOwnNet 🌐

| Field | Value |
|-------|-------|
| Document | PRJ-006_SideEvent_ETHDenver2026.md |
| Version | 3.1.2.1 |
...
5. [Venue Recommendations](#-venue-recommendations)
6. [Content / Agenda](#-content--agenda)
7. [Attendee Strategy](#-attendee-strategy)
8. [Timeline](#-timeline)
9. [Budget](#-budget)
10. [Risk Matrix](#-risk-matrix)
11. [PRJ-003 Synergy](#-prj-003-synergy)
12. [OCPA Group Positioning](#-ocpa-group-positioning)
13. [#FlowsBros Opportunity](#-flowsbros-opportunity)
14. [ETHDenver Registration](#-ethdenver-registration)
...
|-------|-------|
| Project ID | **PRJ-006** |
| Title | #SideEvent_ETHDenver2026 |
| Description | Evening side event during ETHDenver 2026 — positioned after ETHVC Summit |
| Type | Dinner / Networking / Presentation (TBD) |
| Priority | 🔴 P0 (9 days away) |
| Owner | @GTM |
...
| Event | Date | City | Theme |
|-------|------|------|-------|
| PRJ-003 | Thu 12 Feb | Orlando, FL | Redeeming Money — faith + finance |
| **PRJ-006** | **Wed 18 Feb** | **Denver, CO** | **ETHDenver — Web3 + cooperative ownership** |
| Gap | 6 days | Orlando → Denver | @GTM travels between |
...
| Field | Value |
|-------|-------|
| Event Name | #SideEvent_ETHDenver2026 |
| Date | **Wednesday, February 18, 2026** |
| Time | **6:00 PM - 9:00 PM MST** |
| Duration | 3 hours |
| Type | ⬜ TBD (Dinner / Networking / Presentation) |
| Capacity | 15-30 (intimate) |
...
|-------|-------|
| City | Denver, CO |
| Near | National Western Center (ETHDenver venue) |
| Transport | Walking distance or short rideshare preferred |
...
|-------|-------|
| Selected Venue | ⬜ TBD |
| Decision Date | By **Wed 12 Feb** (6 days before) |
| Decision Owner | @GTM |
...
| 4 | OCPA Group — community-owned real estate | D-060 showcase |
...
|------|-----|-----------|-------|--------|
| Mon 09 Feb | W07-D1 | PRJ-006 registered | @GTM | ✅ |
...
|---|--------|-----|------|--------|
| 1 | Claim FREE ETHDenver ticket — @GTM | @GTM | **TODAY** | ⬜ P0 |
| 2 | Claim FREE ETHDenver ticket — @LFG | @LFG | **TODAY** | ⬜ P0 |
| 3 | Claim FREE ETHDenver ticket — @LDC | @LDC | **TODAY** | ⬜ P0 |
| 4 | Apply ETHVC Founders/Builders Pass — @GTM | @GTM | **TODAY** | ⬜ P0 |
| 5 | Apply ETHVC Audience Pass (backup) | @LFG, @LDC | **TODAY** | ⬜ P1 |
...
| ETHDenver Side Events | [ethdenver.com/side-events](https://ethdenver.com/schedule/) |
...
|-----|-------------|------|---------|
| GTM | [yonks](https://GitHub.com/YonksTEAM) | Co-Founder / Chief Digital Alchemist | #FlowsBros call with @LFG + @LDC |
...
|----------|---------|-----------|
| PRJ-003_SideEvent_Redeem2026 | v2.4.0 | Sister event — 6 days prior |
| PRJ-005_DrupalWiki | v3.1.2.1 | Wiki content for event prep |
| SharedKernel | v3.1.1.4 | OCPA Group (D-060), cccbot.eth |
...
|---------|------|------------|----------|---------|
| 3.1.2.1 | 2026-W07 | GTM_2026-W07_026 | ⬜ AWAITING | Initial project brief; ETHVC deep dive; venue recommendations; 9-day timeline; attendee strategy; PRJ-003 synergy; OCPA positioning; #FlowsBros opportunity |
